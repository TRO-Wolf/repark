...
| S2-30 | **Rulings of 2026-09-13 (owner):** EAGER-OWN-1 Q-E1 yes (cache()/persist() views die with their last holder) and Q-E2 refuse-never-evict (the polars-like budget; EAGER-BUDGET-1 D-1); run-9 Q-R9-1 `sha2` direct dependency allowed, Q-R9-2 TOML stays; CFG-2 step-2 public shape accepted, global `auto_register` a later card; SIL-1..SIL-10 tabled (silver S-2 parked). | EAGER-BUDGET-1, silver S-1/S-2, CFG-2 |
