...
- [overnight-report-2026-09-10-run5.md](overnight-report-2026-09-10-run5.md) — run 5 (2026-09-10,
  ...
  from 05:45 and are not in it): six merged (DISPLAY-BRIDGE-1's rebase, AP-0 with its O-run,
  MAINT-POLICY-1 end to end, TORTURE-1 steps 1 and 2, PROFILES-1 step 1), one green at the stop
  (AP-1 step 1), one parked green as a draft (NEVEROOM-1 step 1, on two D-2 ruling questions).
