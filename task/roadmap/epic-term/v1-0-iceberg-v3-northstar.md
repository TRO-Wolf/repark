...
| Read: `_row_id` / `_last_updated_sequence_number` | ✅ V3-4 (2026-08-31): Spark-equal on v3 reads, three doors; v1/v2 unresolved (`V3-ROWID-1` FIXED). Preserve-half stays F-7 | served as columns, Spark-equal | V3-4 |
