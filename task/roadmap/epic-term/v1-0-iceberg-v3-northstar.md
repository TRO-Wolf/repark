...
| Write: COW DML on an adopted v3 table | ⚠ RP-2 (2026-08-27): DELETE on a DV-free table lifted — survivor lineage Spark-equal incl. the `next_row_id` allocate-then-suppress; live-DV tables refuse; UPDATE / MERGE refuse (`V3-COW-1`) | lineage carried per spec | V3-4 ← fork F-7 |
