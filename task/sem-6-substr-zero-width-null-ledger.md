...
**Charter:** [sem-0-charter-ledger.md](sem-0-charter-ledger.md) · **Closes:** registry row `RE-3`
...
`RE-3` was registered one commit earlier by [SEM-5](sem-5-substr-zero-width-ledger.md) and is
