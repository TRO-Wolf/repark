...
| `pyspark.sql.tests.test_serde.SerdeTests.test_time_with_timezone` | `FAIL-VALUE` | datet[18 chars] 8, 8, 13, 44, 53, 821389) != datet[18 chars] 8, 8, 17, 44, 53, 821389, tzinfo=zoneinfo.ZoneInfo(key='UTC')) | `<home>/.cache/repark-pyspark-tests/v4.1.2/python/pyspark/sql/tests/test_serde.py:94 in test_time_with_timezone` |
