# map — task/census/baseline-fc3f48102/expand2/

## Purpose
Recorded evidence for the `expand2` census cohort at the v1 pin (procedure: docs/port/census.md). Never hand-edited; a re-run replaces the whole baseline directory in one commit.
