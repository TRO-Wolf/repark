...
| Q-005 — The CAP-1 parity mirror retained the old 1,485-line `session/tests.rs` baseline after the live guard ratcheted to 1,461. | S1 | REMEDIATED — ratchet the mirror to 1,461 and run the focused census plus the full CI parity harness. |
