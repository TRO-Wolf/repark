...
- The public `CALL system.rewrite_data_files` path is lifted (`V3-LINEAGE-1` FIXED
  2026-08-31, fork #243). Facade and Spark-door pins compact a six-file v3 table and
  assert `_row_id` / `_last_updated_sequence_number` equality on `to_arrow`. The
