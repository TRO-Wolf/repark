...
- `CatalogCaches::trim` reading `metadata_len()` instead of `settled_metadata_len()` (round 2):
  `the_door_trim_settles_before_it_reads_the_high_water_mark` failed 3 of 3 runs, `left: 4`,
  `right: 0` (C-012).
