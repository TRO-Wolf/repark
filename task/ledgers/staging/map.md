...
- [ice-orc-avro-1-ledger.md](ice-orc-avro-1-ledger.md) —
  **ICE-ORC-AVRO-1 (2026-09-22), in flight:** ORC and Avro Iceberg data files
  ...
  compaction cells, red-first in `test_ice_orc_avro_1.py` (22P offline and live).
  Registry `ICE-WRITE-OPTIONS-ORC-AVRO` retires to SERVED; `IO-ORC-1` keeps its
  plain-file writer refusal. `risk_tier: standard`. Branch `fix/ice-orc-avro-1`.
