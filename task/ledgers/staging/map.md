...
- [ipi-20-input-file-name-1-ledger.md](ipi-20-input-file-name-1-ledger.md) —
  **IPI-20-INPUT-FILE-NAME-1 (2026-09-23), in flight:** `input_file_name()` on the
  ...
  zero-argument call to `<alias>._file` inside a single-Iceberg-relation SELECT's
  projection and WHERE; the aggregate-arg, arity, join, VALUES, metadata-table
  and UNION-ALL residues keep `UNRESOLVED_ROUTINE`. C-001..C-009 PROVEN.
