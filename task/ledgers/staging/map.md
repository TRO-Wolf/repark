...
- [ice-rm-deletes-1-ledger.md](ice-rm-deletes-1-ledger.md) —
  **ICE-RM-DELETES-1 (2026-09-20), in flight:** `CALL rewrite_manifests` rewrites delete
  ...
  refusal in the sibling `output-spec-id` shape; 14-cell recorded Spark 4.1.2 oracle plus
  red-first replay pins. `risk_tier: standard`. Branch `fix/ice-rm-deletes-1`.
