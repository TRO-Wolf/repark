...
| C-002 | The audit lists every IPC crossing site with file:line. | §3 of the audit. | **OPEN** | — |
| C-003 | The audit lists every place a `Column` renders SQL text with file:line and what it renders. | §4 of the audit. | **OPEN** | — |
