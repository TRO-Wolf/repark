...
COVERAGE_ATTESTATION:
  ...
  categories:
    ...
    - id: AT-7
      status: ATTACKED
      evidence: C-011 re-measured on RELEASE natives after the step-2b string-FFI remediation. Depth-100 op chain −34.44%/−42.31% (two passes, faster than step-1), depth-500 +3.04%, withColumn-100 −2.54% — all under the 5% bar.
