...
is `target/probe-u9-types-1/spark.json`, 204 probes; the verifier round r2 of 2026-09-25 added 13 steps, 208 in all, 149 EQUAL, recorded to `obs-spark-r2.json` / `obs-repark-r2.json` and merged into the observation files for the new keys only).** A `TIMESTAMP_LTZ` column is Iceberg
