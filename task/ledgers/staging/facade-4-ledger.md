...
| per-call conversions | +13.9 µs (`toDDL` wide50); `repark_type_to_arrow` −3.2 % wide50 / −16.5 % nested3; `simpleString`/`jsonValue` at or under base | inside 1 ms |
...
- Commits: `f8e33cca` ledger skeleton; `585ef87a` pins + goldens + mutation
  ...
  round-3 measurement + perf doc + ledger; this commit the round-4
  L-007..L-009 dispatch restoration, pins, re-measure and ledger.
