...
| C-004 | Cutover W3 rewritten (`partitionOverwriteMode=dynamic` ignored on PARTITION-less overwrite, V2-24b), same tagging and grammar. | Before/after line numbers of row W3. | **PROVEN** | Row W3 at `docs/cutover/production-iceberg-status-2026-09-14.md:192` (was :185). Status PROVEN in part (silent dynamic-overwrite replacement); 5 columns kept; tag present. Round 2 audit: bare PROVEN contradicted its own row. |
| C-005 | Cutover W6 rewritten (plain INSERT INTO ignores the declared sort order, C-7), same tagging and grammar. | Before/after line numbers of row W6. | **PROVEN** | Row W6 at `docs/cutover/production-iceberg-status-2026-09-14.md:195` (was :188). Status PROVEN in part (INSERT INTO ignores the sort order); 5 columns kept; tag present. Round 2 audit: bare PROVEN contradicted its own row. |
...
| C-007 | Cutover M1 rewritten (options map refused on every key, C-4), same tagging and grammar. | Before/after line numbers of row M1. | **PROVEN** | Row M1 at `docs/cutover/production-iceberg-status-2026-09-14.md:222` (was :215). Status PROVEN in part (every options map refused); 5 columns kept; tag present. Round 2 audit: bare PROVEN contradicted its own row. |
...
| C-011 | Cutover V1 rewritten (write-default not applied, C-1), same tagging and grammar. | Before/after line numbers of row V1. | **PROVEN** | Row V1 at `docs/cutover/production-iceberg-status-2026-09-14.md:215` (was :208). Status PROVEN in part (silent write-default NULL); 5 columns kept; tag present. Round 2 audit: bare PROVEN contradicted its own row. |
