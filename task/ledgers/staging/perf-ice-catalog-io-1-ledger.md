...
COVERAGE_ATTESTATION:
  ...
  categories:
    - id: AT-1
      status: ATTACKED
      evidence: Nine Rust pins on two doors over one catalog plus ten always-run Python legs cover the cache mechanics, both knobs, the bound and the staleness contract; three legs skip naming their fork ask.
