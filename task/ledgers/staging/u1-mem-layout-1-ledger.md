...
COVERAGE_ATTESTATION:
  ...
  categories:
    ...
    - id: AT-10
      status: ATTACKED
      evidence: At d1f8fa9b, M-a 3, M-b 1, M-uuid 1, M-filter 35, M-naive 33, M-unless 2, M-norm 2, M-open 1, L-wire 3, L-ns 5, and L-off 5 pins failed. At layout-r7, M-root 2, M-share 1, M-root with M-share 3, M-whole 1, M-over 6, M-fallback-inside 1, and M-reason 1 pins failed. At layout-r8, M-anc 2, M-stop 3, M-whole-anc 2, M-whole-anc with M-stop 9, M-ns 1, and M-cat 1 pins failed.
...
- `cargo test -p repark-spark --lib call_orphan` → `62 passed; 0 failed`
- `cargo test -p repark-spark --lib mem_layout` → `9 passed; 0 failed`
