...
**Retires (line added 2026-08-23 by DL-1's backfill):** this charter moves to `../completed/` when the format-v3 track closes — its queued rows (`V3-DANGLE-1`, `V3-ROWID-1`, …) chartered or declined.
