...
## Coverage attestation (Critic, reissued at `990c70b`)
  ...
  categories:
    - id: AT-1
      ...
      evidence: >
        ...
        990c70b: re-derived every corrected figure. 3.72 + 0.509 = 4.23 h and 1.91 + 0.509 =
      ...
      artifacts: [mw7/full.json, mw7/calib.json, mw7/probe1e7.json, mw7/growth.json, mw7/growthmor.json, "ledger sections 1, 4.1-4.4, 5, 6.1-6.8 at 990c70b"]
    - id: AT-2
      status: ATTACKED
      evidence: >
    ...
    - id: AT-9
      ...
      evidence: >
        ...
        docstring stating why a count cannot answer it. Ran the lockstep gates at 990c70b:
    ...
    - id: AT-10
      ...
      evidence: >
        ...
        11/11 green at 990c70b, and I re-ran the finding's discharge pair myself rather than
        ...
        clone byte-identical, HEAD 990c70b, no stash, origin intact.
      artifacts: [mw7-critic/smoke2.log, mw7-critic/test_smoke.990c70b.bak, "P7a/P7b outputs above", "git status empty at 990c70b"]
