...
`example-coverage: 913 public names (catalog=28, column=40, dataframe=150, functions=444, io=42, ml=28, session=41, ta=86, types=32, window=22); 224 covered; 687 backlog; 2 exceptions; 56 examples`

Before this unit: `913 public names; 224 covered; 687 backlog; 2 exceptions; 56 examples` (at `32c7f30`). After (as merged on `5f587b8`): `197 covered; 768 backlog; 35 examples` — exactly the nine kept names.
