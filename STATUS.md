...
- **Spark function parity campaign** (active, chartered 2026-08-20; first tranche merged as
  ...
  **Delivered:** `__all__` 333 → 360, 41 names from refusing-or-absent to working (FNP-1..6c);
  ...
  Remaining work ships as one coherent PR per unit or tightly coupled pair. **Next, in order
  (revised 2026-08-30):** FNP-15/16 → FNP-4c → FNP-7a/7b → FNP-9/10 → FNP-8 → FNP-11/12 → FNP-Z.
