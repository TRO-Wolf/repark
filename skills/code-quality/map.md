...
[../../AGENTS.md](../../AGENTS.md) "Python"; the skill explains the reasoning and the arming method
that the contract compresses into one bullet.
...
- Up: [../map.md](../map.md)
- Related: [../../docs/skills/Opus.md](../../docs/skills/Opus.md) (the per-tier operating manual
