...
| Active plan tracking | the unit's own `task/<unit>-ledger.md` (see [task/map.md](../../task/map.md)); the live backlog is [STATUS.md](../../STATUS.md) — [task/todo.md](../../task/todo.md) is a pointer to both since 2026-08-09 | BIND | Orchestrator writes the working plan in the unit ledger; no parallel tracker |
