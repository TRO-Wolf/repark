...
fn any_match_for_range(predicate: &BooleanArray, start: usize, end: usize) -> Option<bool> {
...
impl HigherOrderUDFImpl for SparkExists {
...
pub fn exists_udf() -> Arc<HigherOrderUDF> {
    static INSTANCE: LazyLock<Arc<HigherOrderUDF>> =
        LazyLock::new(|| Arc::new(HigherOrderUDF::new_from_impl(SparkExists::new())));
    Arc::clone(&INSTANCE)
}
