...
- **Production-aligned leaves:**
  ...
  the branch where it was. Its module docstring carries the oracle stamp the registry rows
  §2.2 `REF-1`/`REF-3`/`REF-4` cite. pins: ref-branch-tag-wap/C-001, C-002, C-003, C-005),
