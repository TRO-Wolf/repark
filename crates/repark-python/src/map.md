...
| Path | Contract |
|---|---|
| [`lib.rs`](lib.rs) | Module registration, error conversion, and tracing setup. **DF-METADATA-COL-1 (2026-09-16):** registers `dataframe_file_metadata`. pins: df-metadata-col-1/M-4 |
...
| [`dataframe.rs`](dataframe.rs) | Lazy plans, actions, transforms, schema, and Arrow C Stream export. **FNP-4B (2026-09-15):** `filter_sql` parses through `column::expr_build::parse_canonical_predicate` (shared Databricks canonicalization). pins: fnp-4b/C-003 **DF-METADATA-COL-1 (2026-09-16):** select/filter/withColumn/sort plan through `dataframe_file_metadata::ensure_*`; schema fields render the stamped struct key. pins: df-metadata-col-1/M-2, M-4 |
| [`dataframe_file_metadata.rs`](dataframe_file_metadata.rs) | Hidden `_metadata` planning bridge: `ensure_planned`, `ensure_bound`, `ensure_sorts`, the `metadata_field` pyfunction, and the `AnalysisException` fold. pins: df-metadata-col-1/M-2, M-4, M-5 |
