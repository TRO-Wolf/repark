...
| [`static_overwrite.rs`](static_overwrite.rs) | **ICE-DYN-OVERWRITE-1 round 2, ruling Q-20a-6 (2026-09-17):** free `#[pyfunction]` `sql_static_overwrite` (the `session_sources` shape, since `session.rs` sits on its exact CAP-1 baseline): the saveAsTable static entry driving `ReparkSession::sql_static_overwrite` with the GIL detached. Comment-free per the owner's comment ban (2026-09-17). pins: ice-dyn-overwrite-1/L-001 |
