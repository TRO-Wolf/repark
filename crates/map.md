...
binding is what streams rows into it); `repark-distributed → repark-core` (tier-3 runtime; Ballista
is optional behind `cluster`); `repark-python → {repark-core, repark-functions, repark-ta`
