...
- `v3_refs_time_travel.rs` — **V3E-4 (test-only):** ANSI branch/tag + `FOR VERSION AS OF`
  over the Spark-written partitioned v3 DV fixture after a RePark append
  (`Model: Grok 4.6 xHigh`, `CodeQuality:S`).
