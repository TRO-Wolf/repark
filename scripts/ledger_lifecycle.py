...
def _purpose_for(directory: str) -> str:
    ...
    if directory.startswith(ARCHIVE_DIR + "/"):
        ...
        return f"Ledgers archived in {month}; immutable — corrections are dated errata at the top."
...
def archive_map_text(tracked_after: list[str]) -> str:
    ...
    return (
        ...
        "immutable. Generated by `scripts/ledger_lifecycle.py archive`; do not edit by hand.\n\n"
        "## Contents\n" + "".join(rows) + "\n## Pointers\n- Up: [../map.md](../map.md)\n"
