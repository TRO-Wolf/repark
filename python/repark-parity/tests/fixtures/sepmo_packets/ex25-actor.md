...
**Exclusions.** .github/, STATUS.md, briefs/next-sequence.md, crates/, python/repark/src/
...
- typos .`. Hand back `handback.json` at the lane root: `{"status":"done|halt","commits":[...],"covered":[...],"stayed":[...],"gates":"...","notes":"..."}` and end with the roster table (name → script → covered/stayed + reason). Commit early and often; never push yourself.
...
- ownership_boundaries: .github/, STATUS.md, briefs/next-sequence.md, crates/, python/repark/src/
