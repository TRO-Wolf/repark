...
- `test_cap_1_source_file_line_cap.py` — **U11-EDGE-1 round 2 (2026-09-26):** mirror rows
  ratchet `crates/repark-python/src/dataframe.rs` 1017 → 1016 and `dataframe/core.py`
  3991 → 3981 with `scripts/check_rust_file_size.py` / `scripts/check_lib_py.py`.
  ...
  Round 5: the `dataframe/core.py` row ratchets 3979 → 3976 with `scripts/check_lib_py.py`.
...
- `test_cap_1_source_file_line_cap.py` — **PR-B hadoop naming (2026-09-24):** the mirror row follows the PR-B ratchet of `crates/repark-core/src/catalog_config.rs` 1007 → 1006 to match `scripts/check_rust_file_size.py` and the measured file. No other `_RUST_BASELINES` or `_PYTHON_BASELINES` row moves.
...
- `test_cap_1_source_file_line_cap.py` — **WO U5 PR3 (2026-09-25):** the
  `crates/repark-spark/src/alter.rs` mirror row ratchets 1354 → 1353 and the
