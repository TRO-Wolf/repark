...
- `test_cap_1_source_file_line_cap.py` — **COMMENT-CORE-1 (2026-09-13):** `dataframe/core.py` 4468 → 4118 with the script baseline (comments removed, no code change). pins: comment-core-1/C-004
