...
- `test_cap_1_source_file_line_cap.py` — **IPI-26/27 round 1 (2026-09-20):** the `crates/repark-spark/src/alter.rs` mirror row 1449 → 1447 matches the `check_rust_file_size.py` baseline (the comma splitter folds angle tracking into one depth counter, ratchet down).
