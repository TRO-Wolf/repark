...
- `test_cap_1_source_file_line_cap.py` — DISPLAY-POLARS-1 step 4 (2026-09-09): `dataframe/plan_collapse.py` row 1168 → 1357 and `session/session_core.py` row 2411 → 2448 with the script baseline (INCREASE, reason in `scripts/map.md`, owner approval requested at merge). pins: display-polars-1/C-005
