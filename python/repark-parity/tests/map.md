...
- `test_ex_0_example_coverage.py` — **EX-0 (2026-08-31):** the v0.7 example-drift
  ...
  **FNP-11A (2026-09-15):** 1006 → 1017 as the eleven temporal names installed by `functions_temporal.py` join the walked functions family (covered by `docs/examples/functions/temporal_constructors.py`, so the backlog baseline is unchanged). pins: fnp-11a/C-001
...
- `test_cap_1_source_file_line_cap.py` — **FNP-11A (2026-09-15):** the `functions_expr.py` row ratchets 1006 → 1017 with the script baseline (the destubbed `make_timestamp` forwarder keeps the frozen 1.0 signature, D-10). pins: fnp-11a/C-001
