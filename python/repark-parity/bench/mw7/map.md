...
| See how the runbook reclaims a delete-laden file, and the one shape it still cannot | registry row `RDF-1`; pin `test_mw7_scale_smoke.py::test_delete_laden_in_band_file_is_rewritten_and_its_delete_file_survives` (C-011, flipped 2026-09-02, reflipped 2026-09-19 by RP-32 fork #301 — the live delete now survives); the residue is a delete file naming two or more data files, fork ask F-16 |
