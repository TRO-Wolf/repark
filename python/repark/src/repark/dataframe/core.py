...
# === r23 QI1: idents ===
from repark._idents import quote_ident as _quote_ident_sql
...
def _coerce_map_in_arrow_schema(schema: Any) -> tuple[StructType, Any]:
    ...
    from repark.session import _parse_create_dataframe_schema, _sql_type_to_arrow
    from repark.types import struct_type_from_arrow
...
class DataFrame:
    ...
    def _select_with_pandas_udfs(self, items: list[Any]) -> DataFrame:
        ...
        **Contract (U7 + M5 — facade projection rewrite, not a SQL Column expression):**
        ...
        from repark.functions import PandasUDFColumn, PandasUDFType
        from repark.types import _arrow_type_to_repark
    ...
    def pl(self) -> Any:
        ...
        """
        from repark.polars import PolarsFrame
    ...
    def with_column(self, col_name: str, column: Column) -> DataFrame:
        ...
        from repark.functions import PandasUDFColumn, PythonUDFColumn
    ...
    def _select_with_generator(
        ...
        if element_cast is not None:
            from repark.column import _require_allowlisted_spark_cast_token
    ...
    def __getitem__(
        ...
        * ``list`` / ``tuple`` → :meth:`select` of the items (``df[["x", "y"]]``)
        ...
        if isinstance(item, str):
            ...
            if item == "*":
                from repark.functions import col as col_fn
    ...
    def replace(
        ...
        if subset is None:
            ...
            targets = set(subset)
        from repark.functions import lit as lit_fn
        from repark.functions import when
    ...
    def join(
        ...
        Cartesian product, which is a different result set (see the raise below).
    ...
    def approxQuantile(  # noqa: N802
        ...
        from repark.functions import percentile_approx
    ...
    def corr(self, col1: str, col2: str, method: str | None = None) -> float:
        ...
        from repark.errors import PySparkTypeError, PySparkValueError
        from repark.functions import corr as f_corr
    ...
    def cov(self, col1: str, col2: str) -> float:
        ...
        from repark.functions import covar_samp
    ...
    def sampleBy(  # noqa: N802 — PySpark camelCase
        ...
        **r20 G2:** matches Spark's mechanism — ``rand(seed)`` (XORShiftRandom,
        ...
        from repark.functions import lit, rand
    ...
    def dynamicFlatten(  # noqa: N802 — repark-extra camelCase surface
        ...
        *,
        ...
        as a repark-extra in ``docs/divergences.md``.
        ...
        from repark.types import ArrayType, NullType
        from repark.types import StructType as StructTypeType
...
def _pandas_udf_window_frame_bounds(spec: Any) -> tuple[int | None, int | None]:
    ...
    """
    from repark.window import _JVM_LONG_MAX, _JVM_LONG_MIN
...
# =============================================================================
from repark.dataframe.actions_export import DataFrameNaFunctions  # noqa: E402
from repark.dataframe.joins_columns import (  # noqa: E402
    GroupedData,
...
from repark.dataframe.writer_readwriter import (  # noqa: E402
