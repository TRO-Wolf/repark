...
from repark.functions import col as spark_col
from repark.functions import lit as spark_lit
from repark.functions import when as spark_when
...
class PolarsFrame:
    ...
    def join(
        ...
        *,
        ...
        from repark._idents import quote_ident as _quote_ident_ssot
    ...
    def with_row_index(self, name: str = "index", offset: int = 0) -> PolarsFrame:
        ...
        (polars default 0).
        """
        from repark.functions import row_number
...
class StringNameSpace:
    ...
    def starts_with(self, prefix: str) -> Column:
        ...
        from repark.functions import _scalar, lit
    ...
    def replace(self, pattern: str, value: str) -> Column:
        from repark.functions import regexp_replace
    ...
    def len_chars(self) -> Column:
        from repark.functions import length

        return length(self._column)

    def zfill(self, length: int) -> Column:
        from repark.functions import lpad
    ...
    def pad_end(self, length: int, fill_char: str = " ") -> Column:
        from repark.functions import rpad
...
class DatetimeNameSpace:
    ...
    def year(self) -> Column:
        from repark.functions import year

        return year(self._column)

    def month(self) -> Column:
        from repark.functions import month

        return month(self._column)

    def day(self) -> Column:
        from repark.functions import dayofmonth
