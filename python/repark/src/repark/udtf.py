...
def _resolve_return_struct(return_type: Any, *, name: str) -> Any:
    ...
    from repark.types import StructType, _parse_datatype_string
...
def _is_table_arg(value: Any) -> bool:
    ...
    if module.startswith("repark.dataframe") and type_name == "DataFrame":
        return True
...
def _execute_scalar_udtf(
    *,
    ...
    from repark.dataframe import _coerce_map_in_arrow_schema
