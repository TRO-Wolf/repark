...
- [test_ice_write_options_1.py](test_ice_write_options_1.py) —
  **ICE-WRITE-OPTIONS-1 (2026-09-17):** the DataFrame write-option pins over the
  ...
  re-run check, all green 2026-09-17. Round 2 adds SNAP-06 (quote/paren key
  and value round-trip byte-exact through the facade escaper into the
  summary; RePark-only pin, no oracle cell).
