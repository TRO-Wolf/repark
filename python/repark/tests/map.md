...
- `test_fnp15_16_declared_refuse.py` — **FNP-15/16 (2026-08-30):** unreachable and deferred-by-cost
  Spark function refusals. Facade, Spark SQL, ANSI SQL, and `F.expr`. The C-012
  "unsupported" strip-check covers all four FNP-16 family sections. pins: fnp-15-16/C-001,
