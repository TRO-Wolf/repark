...
- [test_ice_column_reorder_1.py](test_ice_column_reorder_1.py) +
  ...
  **ICE-COLUMN-REORDER-1 (2026-09-17):** `ALTER COLUMN … FIRST/AFTER` column moves
  ...
  partition-source moves, whole-struct moves, and the DataFrame door (13 offline tests),
  all on the facade SQL door; the live tier replays Spark and cross-reads both engines'
  moved tables (14 live tests). The ANSI door carries the same move end to end in
