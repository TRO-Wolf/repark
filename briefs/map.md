...
- [next-sequence.md](next-sequence.md) — **the next-sequence slate (2026-08-21, rolling):** one 2026-09-04: the five merged rows left; `CUTOVER-SCHEMA-1` and `DBT-1` filed on the owner's cutover rulings. 2026-09-05: row 6 retires the measured H-3 matrix and names its two residue rows.
