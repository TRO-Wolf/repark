...
- `skills/` — agent-facing runbook skills and, since 2026-08-25, the SEPMO control plane with its bound Critic engine, CCC (release-to-PyPI, context-doc truth-up, disk
