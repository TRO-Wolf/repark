...
| `s5-maintenance-calls` | S5 expire / rewrite_data_files binpack / remove_orphan_files / rewrite_position_delete_files | Spark SQL CALL | DIVERGES | PASS | PASS | **DIVERGES** | `CUTOVER-CTAS-REQ-1` |
