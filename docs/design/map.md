...
- [v1-0-api-review-2026-09-02.md](v1-0-api-review-2026-09-02.md) — **the v1.0 API review packet
  ...
  15 rows, YES-except on 15, NO on 5; all 81 open registry rows map to exactly one surface. §5
  records the one dependency: the additive-only and major-version rules a `yes` would bind are
  **unwritten** in [../release.md](../release.md) "Open items". Rows also as
  [v1-0-api-review-2026-09-02.json](v1-0-api-review-2026-09-02.json) for the status board.
