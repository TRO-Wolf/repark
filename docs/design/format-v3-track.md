...
API review. **Scale is measured (SCALE-v3, 2026-09-02):** `1e7 x 50` on v3 costs 1.59x the v2
merge time and reads the point probe at 0.64x, and the runbook ends at zero delete files where
v2 kept 10,000,000 delete records —
