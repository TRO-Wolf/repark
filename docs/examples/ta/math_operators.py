"""Demonstrate the lowercase rolling-extreme ``ta`` kernels against the recorded goldens.
...
def main() -> None:
    ...
    repark = ReparkSession.builder.appName("ex-ta-math").master("local[1]").getOrCreate()
    try:
