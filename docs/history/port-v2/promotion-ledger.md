...
| Census evidence is never hand-edited; a re-run replaces the whole directory in one commit | HOMED | [docs/port/census.md](../../port/census.md) §3 + [task/census/map.md](../../../task/census/map.md) |
