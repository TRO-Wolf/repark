# Port execution log — the phase-by-phase record (was `task/todo.md`)
...
> **Dated correction, 2026-08-09 (FD-4).** This file was `task/todo.md` — the port's live tracker —
> until the port completed. It is now the **closed execution record** of phases 0–3, including the
> three SEPMO retrospectives, and its checkboxes are history, not a work queue. Its open items were
> migrated to [STATUS.md](../../../STATUS.md) (the live backlog) before the move; the surviving
> `task/todo.md` is a pointer. The paragraph below is the file's original lede, kept as written.
...
definitions and acceptance gate live in [docs/port/PLAN.md](../../port/PLAN.md); this file
tracks execution state only.

## Phase 0 — bootstrap (DONE 2026-08-06, brief: [phase-0-bootstrap.md](phase-0-bootstrap.md))
...
## Phase 1 — engine core (DONE 2026-08-07, brief: [phase-1-engine-core.md](phase-1-engine-core.md), design: [docs/design/session-api.md](../../design/session-api.md))
...
blockers in [task/port/deferred-tests.md](../../../task/port/deferred-tests.md) (phase 2's completeness
...
**What hurt** (rules now in [lessons.md](../../../task/lessons.md) 2026-08-07): a CI job rename silently
...
## Phase 2 — the two SQL doors (DONE 2026-08-08, brief: [phase-2-sql-doors.md](phase-2-sql-doors.md), design: [docs/design/sql-doors.md](../../design/sql-doors.md))
...
**What hurt** (rules in [lessons.md](../../../task/lessons.md) 2026-08-08): typed absence rows can be false
...
- [ ] `repark-postgres` + `repark-excel` — read connectors (v1 `read_postgres` / `read_excel`
      ...
      [phase-2-sql-doors.md](phase-2-sql-doors.md) §4). The 4 deferred-test
      manifest rows re-point here ([task/port/deferred-tests.md](../../../task/port/deferred-tests.md)).
