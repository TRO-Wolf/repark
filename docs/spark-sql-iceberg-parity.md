...
- **PERF-ICE-COUNTSTAR-1** — surfaced 2026-09-04, PERF-ANALYSIS-1 §2 row 4.
  **FIXED-PENDING-PIN** behind the RP-13 fork pin bump. `SELECT count(*)` over a plain
...
- **PERF-ICE-SCANPART-1** — surfaced 2026-09-04, PERF-ANALYSIS-1 §2 row 5.
  **FIXED-PENDING-PIN** behind the RP-13 fork pin bump, with residue. A sub-split-size
