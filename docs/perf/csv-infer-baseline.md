...
| cell | before (NULLABILITY-2 tree) | round 1 | round 2 | round 3 | round 4 | round 5 |
|---|---:|---:|---:|---:|---:|---:|
| `inferSchema=False` median total | 0.086 s | 0.083 s | 0.080 s | 0.077 s | 0.078 s | 0.157 s |
| `inferSchema=True` median total | 2.339 s | 0.079 s | 0.153 s | 0.155 s | 0.153 s | **0.279 s** |
| True / False | 27.2× | 0.95× | 1.90× | 2.01× | 1.96× | **1.78×** |
| plan-time `to_arrow` / `collect` | 34 / 0 | 0 / 0 | 1 / 0 | 1 / 0 | 1 / 0 | **1 / 0** |

Round 5 (2026-09-06), same release native, five `read.csv`+`to_arrow` medians:

| fixture | False | True | True/False | plan `to_arrow` |
|---|---:|---:|---:|---:|
| 300k × 8 (`i,d,nts,ots,dt,s,ni,b`, 28,630,418 B) | 0.157 s | 0.279 s | **1.78×** | 1 |
